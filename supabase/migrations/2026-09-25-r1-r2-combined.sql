-- ============================================================================
-- R1 + R2 COMBINED. Run this once, instead of the two separate files.
--
-- For a project that has not run either R1 or R2. One transaction: if any
-- statement fails, nothing is changed. Guarded throughout, so running it a
-- second time changes nothing (and it is also safe if R1 was already run).
--
-- Contents, in order:
--   R1  teams, avatars, system runs, recognition recipients, Value awards,
--       fluency marks, pulse spread, avatars bucket
--   R2  any member records a practice, files on Value awards, each
...
-- ============================================================================
-- R2 starts here (same transaction)
-- ============================================================================
...
-- ---------------------------------------------------------------- check
-- After running, this should return ten rows.
...
--                       'award_grant_attachments','organizations');
